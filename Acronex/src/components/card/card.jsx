        ...
        <div key={machineItem.id} className={styles.statusAndName}>
            ...
            <div
              className={`${styles.status} ${
                machineItem.moving == true ? styles.moving : styles.stoped
              }`}
            ></div>
          ...
          <div className={styles.nameAndDetail}>
            ...
            >
              ...
              >{`(${machineItem.id}) ${machineItem.description}`}</p>
            </Link>
            <p>
              <span
                className={styles["blue-text"]}
              >{`${machineItem.company}`}</span>
            </p>
          </div>
        </div>
      ))}
                ...
                <div
                  className={`${styles.rectangle} ${getClassByValue(
                    machineItem?.indicadores?.taponamiento ||
                      machineItem.data?.indicadores?.taponamiento
                  )}`}
                >
                ...
                <div
                  className={`${styles.rectangle} ${getClassByValue(
                    machineItem?.indicadores?.evaporacion ||
                      machineItem.data?.indicadores?.evaporacion
                  )} `}
                >
                  <div className={styles.indicadorName}>
              ...
              <div className={styles.row}>
                <div
                  className={`${styles.rectangle}  ${getClassByValue(
                    machineItem?.indicadores?.deriva ||
                      machineItem.data?.indicadores?.deriva
                  )}`}
                >
                  <div className={styles.indicadorName}>
                ...
                <div
                  className={`${styles.rectangle} ${getClassForCalidad(
                    (1 - machineItem?.indicadores?.calidad ||
                      machineItem.data?.indicadores?.calidad) * 100
                  )}`}
                >
                  <div className={styles.indicadorName}>
                    <p
                      className={`${styles.cardTitle} ${
                        (1 - machineItem?.indicadores?.calidad) * 100 < 100
                          ? styles.blackCalidad
                          : ""
                      }`}
                    >
            ...
            <div>
                    ...
                    <p className={styles.valueBoldCosechadora}>
                      {Math.floor(
                        machineItem?.indicadores?.humedad_grano ||
                          machineItem?.data?.indicadores?.humedad_grano
                      )}{" "}
                      %
                    </p>
                  </div>
              ...
              <div className={styles.row}>
                <div className={`${styles.rectangle} ${styles.moving}`}>
                  ...
                  <div className={styles.indicadorValue}>
                    <p className={styles.valueBold}>
                      {machineItem?.indicadores?.rinde_humedo ||
                        machineItem?.data?.indicadores?.rinde_humedo}
                    </p>
                  </div>
                </div>
                <div className={`${styles.rectangle} ${styles.rindeSeco} `}>
                  ...
                  <div className={styles.indicadorValue}>
                    <p className={styles.valueBoldCosechadora}>
                      {machineItem?.indicadores?.rinde_seco ||
                        machineItem?.data?.indicadores?.rinde_seco}
                    </p>
                  </div>
                </div>
              </div>
